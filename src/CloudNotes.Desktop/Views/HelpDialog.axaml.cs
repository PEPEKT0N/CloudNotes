...
namespace CloudNotes.Desktop.Views
{
    public partial class HelpDialog : Window
    {
        ...
        {
            return "<style>" +
                "body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, sans-serif; line-height: 1.6; color: #333; padding: 10px; }" +
                "h1 { color: #1976D2; border-bottom: 2px solid #1976D2; padding-bottom: 10px; margin-top: 0; }" +
                "h2 { color: #333; border-bottom: 1px solid #E0E0E0; padding-bottom: 8px; margin-top: 25px; }" +
                "h3 { color: #555; margin-top: 20px; }" +
                "table { border-collapse: collapse; width: 100%; margin: 15px 0; }" +
                "th, td { border: 1px solid #ddd; padding: 10px 12px; text-align: left; }" +
                "th { background-color: #f5f5f5; font-weight: 600; }" +
                "tr:nth-child(even) { background-color: #fafafa; }" +
                "code { background-color: #f5f5f5; padding: 2px 6px; border-radius: 3px; font-family: 'Consolas', 'Monaco', monospace; font-size: 0.9em; }" +
                ...
                "strong { color: #1976D2; }" +
                "kbd { background-color: #f5f5f5; border: 1px solid #ccc; border-radius: 3px; padding: 2px 5px; font-family: 'Consolas', 'Monaco', monospace; font-size: 0.85em; }" +
